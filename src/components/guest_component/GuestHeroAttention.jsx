...
export default function GuestHeroAttention({ navigate, scrollToId }) {
  return (
    <section id="home" className="relative overflow-hidden hero-guest-bg">
      ...
      <div
        className="absolute -top-32 -left-32 w-[500px] h-[500px] rounded-full animate-pulse-slow pointer-events-none"
        style={{
          background:
            "radial-gradient(circle, rgba(255,123,123,0.18) 0%, transparent 70%)",
        }}
      />
      <div
        className="absolute top-10 right-0 w-[400px] h-[400px] rounded-full animate-pulse-slow pointer-events-none"
        style={{
          background:
            "radial-gradient(circle, rgba(237,52,108,0.12) 0%, transparent 70%)",
          animationDelay: "2s",
        }}
      />
      <div
        className="absolute bottom-0 left-1/3 w-[300px] h-[300px] rounded-full animate-pulse-slow pointer-events-none"
        style={{
          background:
            "radial-gradient(circle, rgba(244,221,221,0.3) 0%, transparent 70%)",
          animationDelay: "4s",
        }}
      />
        ...
        <div className="py-14 sm:py-20 lg:py-28 grid lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div className="flex flex-col items-start text-left">
            ...
            <p className="mt-5 font-barlow text-sm sm:text-base font-medium text-abu max-w-lg leading-relaxed animate-fade-up-delay-2">
              Sempurnakan riasan harianmu dengan kurasi produk kosmetik premium
              berpigmen tinggi. Kumpulkan <em>beauty points</em> di setiap
              transaksi dan nikmati hak istimewa sebagai member VIP.
            </p>
            ...
            <div className="mt-10 flex flex-wrap items-center gap-6 animate-fade-up-delay-4">
              {STATS.map((s, i) => (
                <div key={i} className="text-left">
                  <p className="font-poppins text-2xl font-black text-black">
                    {s.value}
                  </p>
                  <p className="font-barlow text-[11px] font-bold text-abu uppercase tracking-wider">
                    {s.label}
                  </p>
                </div>
              ))}
            ...
            <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-3.5 w-full">
              {[
                {
                  title: "Personalized Shade",
                  desc: "Kecocokan warna akurat sesuai undertone kulitmu.",
                },
                {
                  title: "Glow Tier Reward",
                  desc: "Makin tinggi level, makin melimpah kupon spesial.",
                },
                {
                  title: "Verified Reviews",
                  desc: "Ulasan tekstur dan coverage nyata dari komunitas.",
                },
              ].map((item, i) => (
                <div
                  key={item.title}
                ...
                >
                  ...
                  <p className="font-barlow text-xs font-medium text-abu mt-1.5 leading-relaxed">
                    {item.desc}
                  </p>
                </div>
              ))}
          ...
          <div className="relative w-full max-w-lg mx-auto lg:max-w-none animate-float">
            ...
            <div
              className="absolute -inset-8 rounded-[48px] blur-3xl animate-pulse-slow pointer-events-none"
              style={{
                background:
                  "radial-gradient(ellipse, rgba(237,52,108,0.15) 0%, rgba(255,123,123,0.1) 40%, transparent 70%)",
              }}
            />
            ...
            <div className="relative card-premium p-0 hover:scale-[1.01] transition-all duration-500">
              ...
              <div className="aspect-[4/3] bg-gradient-to-br from-[#FFFBFB] via-white to-pink-soft/20 p-8 flex items-center justify-center overflow-hidden relative">
                <img
                  ...
                  onError={(e) => {
                    e.currentTarget.src = "/img/foundation2.jpg";
                  }}
                />
                {/* Best Seller badge */}
            ...
            {/* Floating mini cards */}
            <div
              className="absolute -bottom-8 -left-6 card-glass px-4 py-3 shadow-lg animate-float"
              style={{ animationDelay: "1s" }}
            >
              <p className="font-poppins text-[10px] font-extrabold text-pink-utama uppercase tracking-wider">
                Flash Deal
              </p>
              <p className="font-barlow text-xs font-bold text-gray-800 mt-0.5">
                Diskon s/d 15% 🔥
            ...
            <div
              className="absolute -top-4 -right-4 card-glass px-4 py-3 shadow-lg animate-float"
              style={{ animationDelay: "2.5s" }}
            >
              <div className="flex items-center gap-1.5">
                <span className="text-amber-400 text-sm">★★★★★</span>
              </div>
              <p className="font-barlow text-[10px] font-bold text-gray-600 mt-0.5">
                2.5K+ Reviews
              </p>
            </div>
          </div>
